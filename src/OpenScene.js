...
class OpenScene extends Phaser.Scene {
    ...
    preload() {
      ...
      console.time("load");
        this.e = true;
        this.background = this.add.rectangle(0, 0, document.documentElement.clientWidth, document.documentElement.clientHeight, 0xFFA500).setOrigin(0).setScrollFactor(0, 0).setScale(2);
